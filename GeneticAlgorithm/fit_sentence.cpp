...
float fitness_function(const Optimization::GeneticAlgorithm::Chromosome<Char>::dna_vector& input) {
...
int main (int argc, char * const argv[]) {
	...
	std::pair<float, Optimization::GeneticAlgorithm::Chromosome<Char>::dna_vector> result = population.evolve(&fitness_function, 0.05);
